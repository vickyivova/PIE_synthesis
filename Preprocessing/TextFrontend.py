...
class ArticulatoryCombinedTextFrontend:
    ...
    def __init__(self,
        ...
        if language == "en":
            ...
            self.expand_abbreviations = lambda x: x
            if not silent:
                print("Created a PIE Text-Frontend")
            ...
            self.expand_abbreviations = lambda x: x
            if not silent:
              print("Created an Abkhaz Text-Frontend")
        ...
        #if self.g2p_lang != "cmn" and self.g2p_lang != "cmn-latn-pinyin" and self.g2p_lang != "pie":
    ...
    def pie_to_ipa(self, pie_text):
        ...
        pie_to_ipa = {
            ...
            "h₃": "ʕw", "r": "r", "l" : "l", "m": "m", "n": "n", "i": "i", "u": "u", "e": "e",
            "o":"o", "ē": "eː", "ō": "oː", "m̥": "mə", "n̥": "nə", "r̥": "rə", "l̥": "lə", "i̯": "j",
            "u̯": "w",  "w": "w", "y": "j", "í": "i", "ú": "u", "é": "e", "ḗ": "eː", "ó":"o", 
            "ṑ": "oː", "H":"ʕ"
            }
        ...
        while i < len(pie_text):
            ...
            if i + 2 <= len(pie_text) and pie_text[i:i+2] in pie_to_ipa:
                ...
                i += 2
            elif pie_text[i] in pie_to_ipa:
                ipa_text += pie_to_ipa[pie_text[i]]
                i += 1
            else:
                ipa_text += pie_text[i]
                i += 1

        ipa_text = ipa_text.lower()
        return ipa_text
    ...
    def get_phone_string(self, text, include_eos_symbol=True, for_feature_extraction=False, for_plot_labels=False):
        ...
        elif self.g2p_lang == "pie":
            phones = self.pie_to_ipa(utt)
        elif self.g2p_lang == "ab":
            phones = self.abkhaz_to_ipa(utt)
        #else:
